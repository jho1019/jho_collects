...
// Position cards, the cash chart, and ledger history — everything Home used
// to own before Phase 9 moved Home to the calendar. The masthead and
// sign-out button that used to live in this route's own header now live in
// the shared (app) layout, since every route needs a way to sign out, not
// just this one.
